...
function checkCookie() {
    ...
    if (age_verification == "" || age_verification == null) {
        jQuery('#age_overlay').css('display','inherit');
        jQuery('#age_controls').css('display','inherit');
...
function submitAge() {
    ...
    drinkAge = jQuery("#country").val();

    month   = jQuery("#a_month").val();
    day     = jQuery("#a_day").val();
    year    = jQuery("#a_year").val();
...
function denyEntry() {
    var err_msg;
    err_msg = "<div id='deny_entry' class='alert alert-danger'>";
    err_msg+=config.deny_message;
    err_msg+= "</div>";
    jQuery('body').prepend(err_msg);
...
function insertHTML() {
    ...
    html = "<div id='age_controls'>";
    html+= "    <form class='form-inline' action='javascript:submitAge();'>";
    html+= "        <div class='row'>";
    html+= "            <div class='col-lg-4 col-md-4 col-sm-4 col-xs-12 col-lg-offset-4 col-md-offset-4 col-sm-offset-4'>";
    html+="                 <img src='"+config.image+"' class='img-responsive'>";
    html+="             </div>";
    html+= "            <div class='col-lg-12 col-md-12 col-xs-12 text-center spacers'>";
    html+= "                <strong>" + config.message + "</strong>";
    html+= "            </div>";
    html+= "        </div>";
    html+= "           <div class='row'>";
    html+= "               <div class='col-lg-12 col-md-12 col-xs-12 text-center spacers'>";
    ...
    html+= "            <div class='row'>"
    html+= "                <div class='col-lg-12 col-md-12 col-xs-12 text-center spacers'>";
    html+= "                    <button class='btn btn-lg btn-primary btn-age-verify'>ENTER</button>";
    html+= "                </div>";
    html+= "            </div>";
    html+= "    </form>";
    html+= "</div>";
